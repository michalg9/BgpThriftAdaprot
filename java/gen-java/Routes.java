...
public class Routes implements org.apache.thrift.TBase<Routes, Routes._Fields>, java.io.Serializable, Cloneable {
  ...
  public Routes(Routes other) {
    ...
    if (other.isSetUpdates()) {
      List<Update> __this__updates = new ArrayList<Update>();
  ...
  public int compareTo(Routes other) {
    ...
    Routes typedOther = (Routes)other;
